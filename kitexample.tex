  ...
  \begin{columns}[t]
    \begin{column}{0.33\textwidth}
      ...
      \begin{block}{Introduction}
        ...
        \end{itemize}
        \vspace{0.5em}
        This project was initiated as a \textbf{Google Summer of Code} project and developed in cooperation with the Communications Engineering Lab of the Karlsruhe Institute of Technology.
      \end{block}
...
uses FIR filters for every detected/selected input signal to mix, filter and decimate this signal from the input spectrum. Output is a message of vectors with samples of all signals.\\[0.5em]
...
\vspace{1.15em}
    ...
    \begin{column}{0.68\textwidth}
      ...
      \begin{block}{GUI}
      \begin{figure}
        \includegraphics[width=0.91\textwidth]{figures/gui3.png}%\vspace{0.1em}
        %\includegraphics[width=0.49\textwidth]{figures/gui2.png}\\[0.2em]
        %\includegraphics[width=0.49\textwidth]{figures/gui3.png}\vspace{0.1em}
        %\includegraphics[width=0.49\textwidth]{figures/gui4.png}
      \end{figure}
      \begin{itemize}
